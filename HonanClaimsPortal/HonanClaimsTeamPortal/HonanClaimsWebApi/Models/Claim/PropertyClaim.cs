...
namespace HonanClaimsWebApi.Models.Claim
{
    public class PropertyClaim
    {
        ...
        public string Quote_Attached1 { get; set; }
        public string Quote_Attached2 { get; set; }
        public string Quote_Attached3 { get; set; }
        public string Quote_Attached4 { get; set; }
        public string Quote_Attached5 { get; set; }
        public string Quote_Attached6 { get; set; }
